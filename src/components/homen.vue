...
const edicoes = ref([
  {
    ...
    homenageados: [
      {
        nome: 'Sarah Maria Mourão Benício',
        foto: '/IMG/pessoa3.svg',
        area: 'Professora',
        nascimento: '10 out. 1938',
        falecimento: '',
        naturalidade: 'Pedro II, Piauí',
        formacao: 'Bacharel em Letras Anglo-germânicas pela Universidade Federal do Ceará',
        atuacao: 'É professora aposentada de Língua e Literatura Anglo-americana da UFPI',
        destaque: 'Publicou o livro "Tempo, eterno tempo',
        descricao: 'Foi professora catedrática de Língua Inglesa no Colégio Estadual Zacarias de Góis e na Escola Técnica Federal do Piauí.',
        secoes: [
          { titulo: null, texto: 'Nasceu em Pedro II-PI em 20/10/1938, filha de Domingos Mourão Filho e de Rosa Edith de Araújo Mourão.' },
          { titulo: null, texto: 'É viúva do Dr. Antônio Benício, o seu amor de vida inteira.' },
          { titulo: 'especialização', texto: 'Especialização em Linguística pela UFPI' },
          { titulo: 'Cargos de destaque', texto: 'Foi colaboradora cultural da Revista Presença.' },
          { titulo: 'Aposentadoria', texto: 'Professora aposentada de Língua e Literatura Anglo-americana da UFPI.' },
          { titulo: 'Homenagem', texto: 'publicou crônicas em vários jornais e livros.'},
        ]
      },
      {
        ...
        atuacao: 'Cursou o primário no Grupo Escolar Marechal Pires ferreira',
        destaque: 'É autora do livro ‘Vivências’',
        descricao: 'Iniciou sua vida profissional no Grupo Escolar Abdias Neves (Teresina) e depois transferiu-se para o Grupo Escolar Marechal Pires Ferreira e Ginásio Professor Felipino Orsano, Pedro II.',
        secoes: [
          { titulo: null, texto: 'nNsceu no lugar Nazaré, município de Pedro II-PI.' },
          { titulo: 'Família', texto: 'Viúva do advogado e ex-prefeito Jose Rodrigues de Castro, mãe de cinco filhos, avó.' },
          ...
          { titulo: 'Obra literária', texto: 'É autora do livro ‘Vivências’, publicado em 2013, ISBN: 978-85-915363-0-6.' },
          { titulo: 'Atuou', texto: 'Professora' },
        ]
      },
    ]
  },
